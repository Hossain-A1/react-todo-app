...
const App = () => {
  ...
  const getData = async () => {
    try {
      const res = await fetch(
        "https://quasar-purring-crate.glitch.me/tasks"
      );
  ...
  return (
    <div className="bg-gradient-to-t from-gray-900 to-green-900 min-h-screen text-xl text-gray-100 py-10 flex flex-col">
